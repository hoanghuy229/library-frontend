...
import { addBook } from "../../../Service/BookApi";


export const AddNewBook:React.FC<{getJwt:string | undefined}> = (props) => {
    ...
    async function submitNewBook() {
        if(props.getJwt !== undefined && title !== '' && author !== '' && categories !== 'Category' && 
    ...
    return(
        <div className="container mt-5 mb-5">
            {
                displaySuccess && 
                <div className="alert alert-success" role="alert">Add new book successfully</div>
            }
            {
                displayWarning && 
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <form method="POST">
                        ...
                        <div>
                            <button type="button" className="btn btn-success mt-3" onClick={submitNewBook}>Add Book</button>
                        </div>
                    </form>
                </div>
            </div>
